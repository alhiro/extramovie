...
//   loadData() async {
//     await discoverController.handleGetDiscoverByGenre(widget.genreId, page);
...
//             body = const Text("Belum ada data baru...");
...
//       onRefresh: () async {
//         var result = await discoverController.handleGetDiscoverByGenreEndless(
//             widget.genreId, page, isRefresh = true);

//         print("result refresh ttrue, $result");
//         if (result) {
...
//       onLoading: () async {
//         var result = await discoverController.handleGetDiscoverByGenreEndless(
//             widget.genreId, page, isRefresh = false);
...
//                           ];
//                         } else {
//                           children = <Widget>[_renderShimmerDiscover()];
//                         }
//                         return Center(
//                           child: Column(
